...
//			}
	...
	private static String EMAIL_BODY_PWD_RESET		= "<p>Bonjour,</p> <p>Nous avons reÃ§u votre demande de rÃ©initialisation de mot de passe. Cliquez sur le lien ci-dessous pour sÃ©lectionner un nouveau mot de passe:</p> <br/> <a href='%s'>RÃ©initialiser votre mot <a/>" ;
	...
	private static String EMAIL_BODY_USER_NEW		= "<p>Bonjour,</p> <p>Nous avons reÃ§u votre demande de rÃ©initialisation de mot de passe. Cliquez sur le lien ci-dessous pour sÃ©lectionner un nouveau mot de passe:</p> <br/> <a href='%s'>RÃ©initialiser votre mot <a/>" ;
	...
	private static String EMAIL_BODY_TPARTY_NEW		= "<p>Bonjour,</p> <p>Nous avons reÃ§u votre demande de crÃ©ation de compte pour votre sociÃ©tÃ©.<p/>" ;
	...
	public static void doPwdResetReq(JSONObject json, HttpServletResponse response) throws Exception {
		...
		if (uEmail!=null){
			...
			//Xin chÃ o Vu,
			//ChÃºng tÃ´i Ä‘Ã£ nháº­n Ä‘Æ°á»£c yÃªu cáº§u Ä‘áº·t láº¡i máº­t kháº©u cá»§a báº¡n. Nháº¥p vÃ o liÃªn káº¿t bÃªn dÆ°á»›i Ä‘á»ƒ chá»�n máº­t kháº©u má»›i:
			//Ä�áº·t láº¡i máº­t kháº©u cá»§a báº¡n
			//Bonjour,
			//Nous avons reÃ§u votre demande de rÃ©initialisation de mot de passe. Cliquez sur le lien ci-dessous pour sÃ©lectionner un nouveau mot de passe:
			//RÃ©initialiser votre mot
			//Hello,
