...
$.i18n().load('www/js/app/group/user/transl', 'vi', '1.0').done(function () {
  //--do something 
  loadTmplAndShow ("www/js/app/group/user/tmpl/tmpl01.html", dataAcc, "#cont");
});*/
...
loadTmplAndShow ("www/js/app/group/user/tmpl/tmpl.html", dataAcc, "#cont");
...
var do_gl_showContent = function(div, content) {
  ...
  $("#btn_send").off("click").on("click", function(e) {
      ...
      var ref = req_gl_Request_Content_Send("ServiceAutUserPubl", "SvNew", dataForm.data);
